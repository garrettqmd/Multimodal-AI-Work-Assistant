...
本项目搭建了一个中央调度工作流，实现了从多源数据（视频/语音/截图/文档）输入、文本降噪清洗、任务路由分发，到最终结果自动化推送（飞书）的完整业务链路。开发者可通过本项目参考复杂大模型工作流在实际业务场景中的落地实践。
...
本项目参考了Andrew Ng 提出的 Prompt 工程原则，重点优化了系统的稳定性：
...
* **大语言模型**: Gemini 3.1 Flash lite preview, Qwen 3.5 397B A17B, Deepseek v3.2等
* **数据处理**: Python 3 
